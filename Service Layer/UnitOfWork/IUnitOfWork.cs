...
namespace Service_Layer.UnitOfWork
{
    public interface IUnitOfWork
    {
        ...
        IAccountSettingEmailNotificationService AccountSettingEmailNotificationService { get; }
        IEmailJobService EmailJob { get; }

        IActivityLogService ActivityLogServiceSave { get; }
        void Save();
