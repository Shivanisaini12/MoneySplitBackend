...
namespace WebAPI.Controllers
{
    ...
    public class ExpenseController : ControllerBase
    {
        ...
        public ExpenseController(IUnitOfWork unitOfWork, IMapper mapper, IHubContext<MessageHub, IMessageHubClient> _messageHub)
        {
        ...
        public IActionResult AddExpense([FromBody] JsonElement expense)
        {
            ...
            if (expenseDTO != null && identity != null)
            {
                ...
                if (res != null)
                {
                    ...
                    expenseNoti = _unitOfWork.Notification.ExpenseNotification(expenseDTO);

                    allNoti=_unitOfWork.Notification.GetNotifications(UserId);
                    messageHub.Clients.All.SendOffersToUser(expenseNoti);
